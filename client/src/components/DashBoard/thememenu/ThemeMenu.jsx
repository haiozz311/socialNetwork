...
import { setColor, settMode } from 'redux/slices/Theme.slice';
...
const ThemeMenu = () => {
    ...
    const setModeItem = mode => {
        setcurrMode(mode.id);
        localStorage.setItem('themeMode', mode.class);
        dispatch(settMode(mode.class));
    };

    const setColorItem = color => {
                    ...
                    <ul className="mode-list">
                        {
                            mode_settings.map((item, index) => (
                                <li key={index} onClick={() => setModeItem(item)}>
                    ...
                    <ul className="mode-list">
                        {
                            color_settings.map((item, index) => (
                                <li key={index} onClick={() => setColorItem(item)}>
