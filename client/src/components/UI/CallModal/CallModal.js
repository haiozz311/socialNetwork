...
const CallModal = () => {
  ...
  const addCallMessage = useCallback((call, times, disconnect) => {
    if (call.recipient !== userInfo._id || disconnect) {
      const msg = {
        sender: call.sender,
      ...
      console.log('addCallMessage', msg);
      dispatch(addMessage({ msg, userInfo, refresh_token, socket }));
    }
  ...
  //     dispatch(addMessage({ msg, userInfo, refresh_token, socket }));
  //   }
  // }, [userInfo,refresh_token, dispatch, socket]);
    ...
    <div className='call_modal'>
      <div className='call_box'>
        ...
        <div className="call_menu">
          ...
          {
            (call.recipient === userInfo._id && !answer) &&
            <>
                {
                  call.video
